        ...
        <div class="flex-1">
            <div class="container mx-auto px-4 mt-4 mt-40">
                <div class="text-gray-500 text-sm mb-6">
                    ...
                    <span class="font-bold text-black cursor-pointer" @click="router.push('/chekout')">Checkout</span>
                    <span class="mx-2">&gt;</span>
                    <span class="font-bold cursor-pointer" @click="router.push('/payment')">Payment</span>
                </div>
            </div>
            <div class="container mx-auto px-4 flex flex-col lg:flex-row gap-6 mt-10 mb-20">
                ...
                <div class="bg-white shadow-lg rounded-lg p-6 w-full lg:w-1/3 max-h-[280px]">
                    ...
                    <hr class="mt-5 mb-3">
                    <button  @click="router.push('/payment')" class="mt-4 bg-green-400 text-white w-full py-2 rounded hover:bg-green-500 transition">
                        Select Payment
                    </button>
                </div>
            </div>
